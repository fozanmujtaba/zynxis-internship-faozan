...
def lookup(query: str) -> str:
    """Return a known fact from a small knowledge base."""
    facts = {
...
def run_react(puzzle: str, max_steps: int = 12) -> str:
    ...
    for step in range(max_steps):
        ...
        # Done if the agent wrote its final answer
        ...
        # Rebuild message history with the updated trace
        messages = [
            {
                "role": "user",
...
if __name__ == "__main__":
    ...
    # Print the trace with clear section labels
    for line in trace.splitlines():
        if line.startswith("Thought:"):
            print(f"\n\033[94m{line}\033[0m")       # blue
        elif line.startswith("Action:"):
            print(f"\033[93m{line}\033[0m")          # yellow
        elif line.startswith("Observation:"):
            print(f"\033[92m{line}\033[0m")          # green
        elif line.startswith("Answer:"):
            print(f"\n\033[1m\033[95m{line}\033[0m") # bold magenta
        else:
            print(line)
